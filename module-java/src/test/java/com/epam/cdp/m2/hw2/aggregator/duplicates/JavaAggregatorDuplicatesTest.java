...
public abstract class JavaAggregatorDuplicatesTest {
    ...
    public static List<Object[]> data() {
        ...
        data.add(new Object[]{2, asList("dog", "word", "intellij", "a", "b", "dog", "word", "intellij"), asList("DOG", "WORD", "INTELLIJ")});
        data.add(new Object[]{3, emptyList(), emptyList()});
        data.add(new Object[]{3, singletonList("www"), emptyList()});
        return data;
    }
